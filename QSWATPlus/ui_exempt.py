...
# Form implementation generated from reading ui file 'K:/Users/Public/QSWATPlus3/QSWATPlus\ui_exempt.ui'
#
...
class Ui_ExemptDialog(object):
    def setupUi(self, ExemptDialog):
        ...
        self.buttonBox.accepted.connect(ExemptDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(ExemptDialog.reject) # type: ignore
