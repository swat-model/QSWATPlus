...
class TestPoly(unittest.TestCase):
    ...
    def test10(self):
        ...
        shapes.addRow(np.array([2, 1, 2, 1, 2, 1, 1, 1, 1, 1], dtype=np.int32), 0)
        shapes.addRow(np.array([1, 2, 2, 1, 1, 1, 1, 1, 2, 1], dtype=np.int32), 1)
        shapes.addRow(np.array([1, 1, 1, 1, 1, 2, 1, 1, 1, 2], dtype=np.int32), 2)
        shapes.addRow(np.array([1, 1, 2, 1, 2, 1, 1, 1, 1, 2], dtype=np.int32), 3)
        shapes.addRow(np.array([1, 1, 1, 1, 1, 1, 2, 2, 1, 1], dtype=np.int32), 4)
        shapes.addRow(np.array([1, 2, 1, 1, 1, 2, 1, 2, 1, 1], dtype=np.int32), 5)
        shapes.addRow(np.array([2, 1, 1, 2, 1, 1, 1, 1, 1, 1], dtype=np.int32), 6)
        shapes.addRow(np.array([2, 1, 1, 1, 1, 2, 1, 1, 1, 2], dtype=np.int32), 7)
        shapes.addRow(np.array([1, 1, 1, 2, 1, 1, 1, 1, 1, 1], dtype=np.int32), 8)
    ...
    def test11(self):
        ...
        shapes.addRow(np.array([1,2,1,1], dtype=np.int32), 0)
        shapes.addRow(np.array([1,1,2,1], dtype=np.int32), 1)
        shapes.addRow(np.array([2,2,1,2], dtype=np.int32), 2)
        shapes.addRow(np.array([1,2,1,2], dtype=np.int32), 3)
        shapes.finish()
