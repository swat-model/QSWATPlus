...
class TestQswat(unittest.TestCase):
    ...
    def test01(self):
        ...
        QtTest.QTest.mouseClick(self.delin._dlg.delinRunButton2, Qt.MouseButton.LeftButton)
        self.assertTrue(self.delin.areaOfCell > 0, 'Area of cell is ' + str(self.delin.areaOfCell))
        QtTest.QTest.mouseClick(self.delin._dlg.OKButton, Qt.MouseButton.LeftButton)
        ...
        QtTest.QTest.mouseClick(hrudlg.insertButton, Qt.MouseButton.LeftButton)
        ...
        QtTest.QTest.mouseClick(hrudlg.filterLanduseButton, Qt.MouseButton.LeftButton)
        self.assertTrue(hrudlg.percentButton.isEnabled(), 'Percent button not enabled')
        QtTest.QTest.mouseClick(hrudlg.percentButton, Qt.MouseButton.LeftButton)
        ...
        QtTest.QTest.mouseClick(hrudlg.landuseButton, Qt.MouseButton.LeftButton)
        hrudlg.soilVal.setText('10')
        self.assertTrue(hrudlg.soilButton.isEnabled(), 'Soil button not enabled')
        QtTest.QTest.mouseClick(hrudlg.soilButton, Qt.MouseButton.LeftButton)
        hrudlg.slopeVal.setText('5')
        self.assertTrue(hrudlg.createButton.isEnabled(), 'Create button not enabled')
        QtTest.QTest.mouseClick(hrudlg.createButton, Qt.MouseButton.LeftButton)
    ...
    def test02(self):
        ...
        QtTest.QTest.mouseClick(hrudlg.filterAreaButton, Qt.MouseButton.LeftButton)
        self.assertTrue(hrudlg.areaButton.isEnabled(), 'Area button not enabled')
        QtTest.QTest.mouseClick(hrudlg.areaButton, Qt.MouseButton.LeftButton)
    ...
    def test03(self):
        ...
        # QtTest.QTest.mouseClick(self.delin._dlg.mergeButton, Qt.MouseButton.LeftButton)
...
#         # QtTest.QTest.mouseClick(self.delin._dlg.addButton, Qt.MouseButton.LeftButton)
#         self.delin.addReservoirs()
    ...
    def test04(self):
        ...
        self.delin._dlg.numProcesses.setValue(0)
        QtTest.QTest.mouseClick(self.delin._dlg.existRunButton, Qt.MouseButton.LeftButton)
    ...
    def test05(self):
        ...
        #QtTest.QTest.mouseClick(selSubs._dlg.pushButton, Qt.MouseButton.LeftButton)
        selSubs.selectByThreshold()
        self.waitCountChanged(subbasinsLayer.selectedFeatureCount, 0)
        #QtTest.QTest.mouseClick(selSubs._dlg.saveButton, Qt.MouseButton.LeftButton)
        selSubs.save()
    ...
    def test06(self):
        ...
        QtTest.QTest.mouseClick(L._dlg.createButton, Qt.MouseButton.LeftButton)
        QtTest.QTest.mouseClick(L._dlg.doneButton, Qt.MouseButton.LeftButton)
        self.waitLayerAdded(numLayers)
        ...
        QtTest.QTest.mouseClick(hrudlg.dominantLanduseButton, Qt.MouseButton.LeftButton)
    ...
    def test07(self):
        ...
        # self.assertTrue('7 snapped: 1 failed' in self.delin._dlg.snappedLabel.text(), 'Unexpected snapping result: {0}'.format(self.delin._dlg.snappedLabel.text()))
        self.delin._dlg.snapThreshold.setText('600')
        QtTest.QTest.mouseClick(self.delin._dlg.gridBox, Qt.MouseButton.LeftButton)
    ...
    def test08(self):
        ...
        QtTest.QTest.mouseClick(self.delin._dlg.useGrid, Qt.MouseButton.LeftButton)
        ...
        QtTest.QTest.mouseClick(self.delin._dlg.drainStreamsButton, Qt.MouseButton.LeftButton)
        self.assertTrue(self.delin._dlg.reuseButton.isEnabled(), 'Reuse button not enabled')
        QtTest.QTest.mouseClick(self.delin._dlg.reuseButton, Qt.MouseButton.LeftButton)
        QtTest.QTest.mouseClick(self.delin._dlg.existRunButton, Qt.MouseButton.LeftButton)
        self.assertTrue(self.delin.isDelineated, 'Delineation incomplete')
        QtTest.QTest.mouseClick(self.delin._dlg.OKButton, Qt.MouseButton.LeftButton)
        self.assertTrue(self.dlg.hrusButton.isEnabled(), 'HRUs button not enabled')
    ...
    def test09(self):
        ...
        self.assertTrue(self.delin._dlg.drainStreamsButton.isEnabled(), 'Streams drainage option not enabled')
        self.assertTrue(self.delin._dlg.drainTableButton.isEnabled(), 'Table drainage option not enabled')
        QtTest.QTest.mouseClick(self.delin._dlg.drainGridButton, Qt.MouseButton.LeftButton)
        self.assertTrue(self.delin._dlg.recalcButton.isEnabled(), 'Recalculate button not enabled')
        QtTest.QTest.mouseClick(self.delin._dlg.recalcButton, Qt.MouseButton.LeftButton)
        QtTest.QTest.mouseClick(self.delin._dlg.existRunButton, Qt.MouseButton.LeftButton)
        self.assertTrue(self.delin.isDelineated, 'Delineation incomplete')
        QtTest.QTest.mouseClick(self.delin._dlg.OKButton, Qt.MouseButton.LeftButton)
        self.assertTrue(self.dlg.hrusButton.isEnabled(), 'HRUs button not enabled')
    ...
    def test10(self):
        ...
        self.assertTrue(self.delin._dlg.drainStreamsButton.isEnabled(), 'Streams drainage option not enabled')
        self.assertTrue(self.delin._dlg.drainTableButton.isEnabled(), 'Table drainage option not enabled')
        QtTest.QTest.mouseClick(self.delin._dlg.drainTableButton, Qt.MouseButton.LeftButton)
    ...
    def test15(self):
        ...
        QtTest.QTest.mouseClick(self.delin._dlg.landscapeButton, Qt.MouseButton.LeftButton)
        lscape = self.delin.L
        ...
        QtTest.QTest.mouseClick(lscape._dlg.createButton, Qt.MouseButton.LeftButton)
        ...
        QtTest.QTest.mouseClick(lscape._dlg.doneButton, Qt.MouseButton.LeftButton)
        QtTest.QTest.mouseClick(self.delin._dlg.OKButton, Qt.MouseButton.LeftButton)
        self.assertTrue(self.dlg.hrusButton.isEnabled(), 'HRUs button not enabled')
        self.hrus.init()
        hrudlg = self.hrus._dlg
